...
import { setGlobalCursorWait, resetGlobalCursor } from "../cursorlogic.js";
export function initializeAuthRules() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (token) {
            ...
            localStorage.setItem("username", username); // username можно оставить в localStorage
            ...
            if (profileResponse.ok) {
              ...
              localStorage.setItem("userId", userId); // userId можно оставить в localStorage
              showSuccess();
